...
namespace Practical1Test
{
    internal class Task2_ArrayCalculations_Tests
    {
        ...
        {
            int[] result = Task2.Program.GenerateRandomArray(5, 1, 10);
        ...
        {
            int[] result = Task2.Program.GenerateRandomArray(100, 1, 10);
        ...
        {
            int[] array = { 1, 2, 3, 4, 5 };
            int result = Task2.Program.GetSum(array);
        ...
        {
            int[] array = { 2, 4, 6, 8 };
            double result = Task2.Program.GetAverage(array);
        ...
        {
            int[] array = { 5, 2, 8, 1, 9 };
            int result = Task2.Program.GetMin(array);
        ...
        {
            int[] array = { 5, 2, 8, 1, 9 };
            int result = Task2.Program.GetMax(array);
